...
public class Ws320ImplService extends Service {
    ...
    public Ws320ImplService(WebServiceFeature ... features) {
    ...
    //API jar or re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1
    //compliant code instead.
    public Ws320ImplService(URL wsdlLocation, WebServiceFeature ... features) {
    ...
    //API jar or re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1
    //compliant code instead.
    public Ws320ImplService(URL wsdlLocation, QName serviceName, WebServiceFeature ... features) {
    ...
    public Ws320 getWs320ImplPort() {
        return super.getPort(Ws320ImplPort, Ws320.class);
    }
     ...
     */
    @WebEndpoint(name = "Ws320ImplPort")
    public Ws320 getWs320ImplPort(WebServiceFeature... features) {
        return super.getPort(Ws320ImplPort, Ws320.class, features);
    }
